...
<h4 class="modal-title" id="myModalLable"><?php echo lang('add_payment'); ?></h4>
</div>
<?php $attrib = ['data-toggle' => 'validator', 'role' => 'form'];
echo admin_form_open_multipart('task/add_payment/' . $inv->id, $attrib); ?>
<div class="modal-body">
    ...
    <input type="hidden" value="<?php echo $inv->id; ?>" name="task_id"/>
    </div>
    <div class="clearfix"></div>
    <div id="payments">
        <div class="well well-sm well-1">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="payment">
                            <div class="form-group">
                                ...
                                value="<?= $thhis->sma->formatDecimal($inv->grand_total - $inv->paid) ?>"
    ...
    <div class="row">
        <div class="col-md-6">
            <input name="pcc-no" type="text" id="pcc_no_1" class="form-control"
