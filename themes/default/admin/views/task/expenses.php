...
<script>
    $(document).ready(function () {
        oTable = $('#EXPData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('task/getExpenses'); ?>',
...
<?php if ($Owner) {
    echo admin_form_open('task/expense_actions', 'id="action-form"');
} ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('task/add_expense') ?>" data-toggle="modal" data-target="#myModal">
